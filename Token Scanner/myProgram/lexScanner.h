...
{
	KEYWORD,
	// keywords of BIOLA, like return, display, read, if, loopBegin, loopEnd, function, functionCall, …
...
//****************************************************************************
// The following defines an enumeration type to 
// symbolically encode the categories of tokens (as integers implicitly).
//****************************************************************************
